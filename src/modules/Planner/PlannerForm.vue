    ...
    <div>
            ...
            <div v-else-if="step === 4 && dinnerSelected" class="flex flex-col gap-5">
                ...
                <div class="grid gap-3 grid-cols-2">
                    <button v-for="food in foodOptions" :key="food.id" type="button"
                        ...
                        <component v-if="foodIcons[food.id]" :is="foodIcons[food.id]" class="size-8 text-pink-400" />
        ...
        <transition name="fade">
            <div v-if="showNoDialog" class="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
                <div class="mx-auto w-full max-w-sm overflow-hidden rounded-3xl bg-white p-6 text-center shadow-2xl">
                    ...
                    <button type="button" class="mt-6 rounded-full bg-pink-400 px-6 py-3 text-white hover:bg-pink-500"
                        @click="closeNoDialog">
                        Vale
                    </button>
                </div>
